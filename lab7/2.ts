...
class infoVehicleStorage<T extends Vehicle> implements VehicleStorage<T> {
    ...
    getIncludeInfo(rightData: string): T[] {
        return this.vehicle.filter((vehicle) => vehicle.brand === rightData);
    }
}
...
//Задание 2
console.log('\n\nНовый массив');
console.log(legendCarStorage.getIncludeInfo('TOYOTA'));
console.log(legendCarStorage.getIncludeInfo('Toyota'));


//Задание 3
let teslaModelX12 = new infoCar(
    'Tesla',
    'Model X',
    new Date(2015),
    'ABC123',
...
teslaModelX12.someInfoVehiclePrint();